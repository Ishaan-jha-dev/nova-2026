...
const timeline = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: '10AM – 10:30AM',label: 'Photo Competition Announcement', highlight: 'green' },
      { time: '10:30AM – 1PM', label: 'MUN - Part 1 & Dance Competition', highlight: 'green' },
      ...
      { time: '5PM – 6:30PM',  label: 'The Inner Spotlight - Round 2', highlight: 'green' },
      { time: '5PM – 5:30PM',  label: 'Informal Networking & Treasure Hunt', highlight: null },
      { time: '5:30PM – 6:30PM', label: 'Informal Networking & Photo Comp Submission', highlight: null },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '11AM – 12PM',   label: 'Academic Session: Prof. Suresh (Entrepreneurship)', highlight: 'red' },
      { time: '11AM – 1PM',    label: 'MUN - Part 2', highlight: 'green' },
      { time: '12PM – 1PM',    label: 'Professor Session 2', highlight: 'red' },
      { time: '1PM – 2PM',     label: 'Lunch', highlight: null },
      { time: '2PM – 3PM',     label: 'Startup Founders Session', highlight: 'red' },
      { time: '2PM – 4PM',     label: 'Startup Challenge Competition & MUN - Part 2', highlight: 'green' },
      { time: '3PM – 4:30PM',  label: 'Open Interaction / Wrap-Up', highlight: null },
      { time: '4:30PM – 5PM',  label: 'High Tea & Networking', highlight: null },
  ...
  },
  {
    ...
    events: [
      { time: '9AM – 10AM',    label: 'Entry, Announcements & Competition Briefing', highlight: null },
      { time: '10AM – 12:30PM',label: 'Talent Show "Lunch Break" & Case Comp (Finals)', highlight: 'yellow' },
      { time: '12:30PM – 1PM', label: 'Quiz Finals & Evaluation', highlight: 'yellow' },
      { time: '1PM – 2PM',     label: 'Lunch', highlight: null },
      { time: '2PM – 2:30PM',  label: 'The Inner Spotlight - Round 3 (Cultural Event)', highlight: 'yellow' },
      { time: '2:30PM – 5PM',  label: 'Prize Distribution & Closing Ceremony', highlight: 'red' },
