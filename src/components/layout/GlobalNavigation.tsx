    ...
    <>
      ...
      {pathname !== '/' && (
        <button
          onClick={() => router.back()}
          aria-label="Go back"
          className="fixed top-5 left-5 z-[100] flex items-center justify-center w-[72px] h-[52px] rounded-full transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shadow-black/25 group border border-[#FF3366]/30 bg-[#0c0d10]/90 backdrop-blur-xl hover:border-[#FF3366] hover:shadow-[0_0_25px_rgba(255,51,102,0.25)]"
        >
          <ArrowLeft size={24} className="text-[#FF3366] group-hover:-translate-x-1 transition-transform" />
        </button>
      )}
      ...
      <button
        ...
        className="fixed top-5 right-5 z-[100] flex flex-col items-center justify-center gap-[6px] w-[72px] h-[52px] rounded-full transition-all duration-300 group hover:scale-105 active:scale-95 shadow-lg shadow-black/25 border border-[#FF3366]/30 bg-[#0c0d10]/90 backdrop-blur-xl hover:border-[#FF3366] hover:shadow-[0_0_25px_rgba(255,51,102,0.25)] hover:gap-[8px]"
      >
        <span className="block h-[2.5px] w-7 bg-[#FF3366] rounded-full transition-all" />
        <span className="block h-[2.5px] w-5 bg-[#FF3366]/90 rounded-full transition-all" />
        <span className="block h-[2.5px] w-7 bg-[#FF3366] rounded-full transition-all" />
      </button>
      ...
      <aside
        ...
        style={{
          ...
          background: 'linear-gradient(160deg, #1c0505 0%, #0d0103 100%)',
          borderLeft: '1px solid rgba(255,51,102,0.15)',
        }}
      >
        {/* Drawer Header */}
        <div className="flex items-center justify-between px-8 pt-6 pb-5 border-b border-[#FF3366]/10">
        ...
        <nav className="flex-1 px-8 py-10 flex flex-col gap-5 justify-center overflow-y-auto">
          <div className="text-[10px] font-black uppercase tracking-[0.3em] text-[#FF3366]/70 mb-1">
            Navigation
          </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? 'text-[#FF3366]' : 'text-white/50 hover:text-white'
                )}
                style={{
              ...
              >
                {link.label}
                {active && (
                  <span className="absolute -left-5 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-[#FF3366] shadow-[0_0_8px_#FF3366]" />
                )}
              </Link>
            )
          })}
        ...
        <div className="px-8 py-8 border-t border-[#FF3366]/10 flex flex-col gap-3">
          {user ? (
            <button
            ...
            <>
              ...
              <Link
                href="/login"
                onClick={() => setOpen(false)}
                className="w-full py-3.5 text-center rounded-xl bg-white/5 border border-white/10 hover:border-[#FF3366]/30 hover:bg-[#FF3366]/5 text-white/50 hover:text-white text-sm font-bold uppercase tracking-wider transition-all duration-200"
              >
                Login
              </Link>
            </>
