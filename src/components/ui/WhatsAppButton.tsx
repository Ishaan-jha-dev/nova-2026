...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center gap-2 px-3 py-3 md:px-5 md:py-3 rounded-full bg-black/60 border border-emerald-500/30 hover:border-emerald-400 text-emerald-400 hover:text-emerald-300 backdrop-blur-md transition-all duration-300 hover:scale-105 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.5),_inset_0_1px_0_rgba(255,255,255,0.05)] hover:shadow-[0_0_25px_rgba(16,185,129,0.25)] group"
      aria-label="Join WhatsApp Group for Queries"
      style={{
    ...
    >
      ...
      <span className="hidden md:inline text-[10.5px] font-bold tracking-widest uppercase transition-colors duration-300">
        Queries? Join WhatsApp
      </span>
