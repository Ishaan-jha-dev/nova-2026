        ...
        <div className="max-w-4xl mx-auto">
          <div className="nova-card rounded-3xl p-10 text-center relative overflow-hidden glow-border-pink entrance-3 group">
            ...
            <div className="relative z-10">
              ...
              >
                <span className="relative z-10 font-bold flex items-center gap-2">Get Started <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" /></span>
              </Link>
            </div>
          </div>
        </div>
