  ...
  return (
    <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg"
      ...
      <g fill="none" stroke="#E8A020">
        {arms.map(deg => {
          ...
          return (
            <g key={deg}>
              ...
              <rect x={x2 - 4} y={y2 - 4} width="8" height="8"
                transform={`rotate(45 ${x2} ${y2})`}
                fill="#E8A020" fillOpacity="0.5" strokeWidth="0" />
              {([-25, 25] as number[]).map(offset => {
                const forkRad = ((deg + offset) * Math.PI) / 180
                const mx = 150 + Math.cos(rad) * 75
                const my = 150 + Math.sin(rad) * 75
                return <line key={offset} x1={mx} y1={my}
                  x2={mx + Math.cos(forkRad) * 30}
                  y2={my + Math.sin(forkRad) * 30}
                  strokeWidth="0.6" stroke="#E8A020" opacity="0.45" />
              })}
            </g>
          )
        })}
        ...
        {([[60,80],[90,40],[200,60],[240,90],[70,200],[50,240],[210,210],[250,250],[130,30],[170,270],[30,130],[270,170]] as number[][]).map(([cx, cy], i) => (
...
export default async function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      {/* Starburst corners */}
      <div className="absolute pointer-events-none" style={{ top: '-5vmin', left: '-5vmin', width: '42vmin', height: '42vmin' }}>
        <StarburstCorner opacity={0.5} />
      </div>
      <div className="absolute pointer-events-none" style={{ top: '-5vmin', right: '-5vmin', width: '42vmin', height: '42vmin', transform: 'scaleX(-1)' }}>
        <StarburstCorner opacity={0.5} />
      </div>
      ...
      <header className="relative z-10 w-full text-center px-4 pt-1 pb-4">
        ...
        <p style={{ fontFamily: '"Playfair Display", Georgia, serif', fontStyle: 'italic', fontSize: 'clamp(1rem, 2.5vw, 1.4rem)', color: '#E8A020', letterSpacing: '0.04em', marginBottom: '2px' }}>
          Welcome to
        </p>
        <h1 className="flex flex-wrap items-baseline justify-center leading-none" style={{ gap: '0.4em' }}>
          <span style={{ fontFamily: '"Playfair Display", Georgia, "Times New Roman", serif', fontWeight: 900, fontSize: 'clamp(2.8rem, 7.5vw, 6rem)', color: '#FFFFFF', letterSpacing: '0.08em', textTransform: 'uppercase', lineHeight: 1 }}>
            NOVA
          </span>
          <span style={{ fontFamily: '"Playfair Display", Georgia, "Times New Roman", serif', fontWeight: 700, fontStyle: 'italic', fontSize: 'clamp(2.2rem, 6vw, 4.8rem)', letterSpacing: '0.05em', textTransform: 'uppercase', lineHeight: 1, background: 'linear-gradient(135deg, #FBBF24 0%, #E8A020 50%, #C8800A 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            UNPLUGGED &apos;26
          </span>
        </h1>
      ...
      <main className="relative z-10 flex-1 w-full max-w-[1300px] mx-auto px-4 pb-6 grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
        ...
        <div className="relative flex flex-col" style={{ paddingTop: '20px' }}>
          ...
          <Link href="/dashboard/events"
            ...
            <h2 className="font-black text-lg uppercase tracking-[0.25em] text-white text-center mb-2">My Events</h2>
            ...
            <div className="w-full flex-1 flex flex-col items-center justify-center">
              {registrations && registrations.length > 0 ? (
                ...
                <div className="flex flex-col items-center py-8">
                  ...
                  <p className="font-bold uppercase tracking-[0.2em] text-xs" style={{ color: 'rgba(255,255,255,0.35)' }}>No Events Registered</p>
                </div>
              )}
            </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="relative flex flex-col" style={{ paddingTop: '20px' }}>
            ...
            <Link href="/dashboard/announcements"
              ...
              <h2 className="font-black text-base uppercase tracking-[0.22em] text-white text-center mb-1">✦ Live Updates ✦</h2>
          ...
          <div className="relative flex flex-col flex-1" style={{ paddingTop: '20px' }}>
            ...
            <div className="flex-1 flex flex-col rounded-2xl p-6 overflow-hidden"
              ...
              <h2 className="font-black text-base uppercase tracking-[0.22em] text-white text-center mb-1">✦ Countdown ✦</h2>
        ...
        <div className="relative flex flex-col" style={{ paddingTop: '20px' }}>
          ...
          <div className="flex-1 flex flex-col items-center rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1"
            ...
            <h2 className="font-black text-base uppercase tracking-[0.18em] text-white text-center mb-1">✦ Digital Gate Pass ✦</h2>
            <div className="flex justify-center gap-1.5 mb-4">
