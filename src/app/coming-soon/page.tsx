  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-2xl mx-auto relative" style={{ zIndex: 10 }}>
        ...
        {/* WhatsApp CTA */}
        <div style={{ animation: 'fadeSlideUp 0.7s 0.7s ease both', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.2rem' }}>
          <a
            ...
            style={{
              ...
              boxShadow: '0 0 30px rgba(37,211,102,0.2), inset 0 1px 0 rgba(255,255,255,0.12)',
              transition: 'all 0.35s cubic-bezier(0.22,1,0.36,1)',
            }}
            onMouseEnter={e => {
              const el = e.currentTarget as HTMLAnchorElement
              el.style.background = 'linear-gradient(135deg, rgba(37,211,102,0.3) 0%, rgba(37,211,102,0.15) 100%)'
              el.style.borderColor = 'rgba(37,211,102,0.9)'
              el.style.boxShadow = '0 0 50px rgba(37,211,102,0.45), 0 8px 24px rgba(37,211,102,0.2), inset 0 1px 0 rgba(255,255,255,0.2)'
              el.style.transform = 'translateY(-2px)'
            }}
            onMouseLeave={e => {
              const el = e.currentTarget as HTMLAnchorElement
              el.style.background = 'linear-gradient(135deg, rgba(37,211,102,0.18) 0%, rgba(37,211,102,0.08) 100%)'
              el.style.borderColor = 'rgba(37,211,102,0.5)'
              el.style.boxShadow = '0 0 30px rgba(37,211,102,0.2), inset 0 1px 0 rgba(255,255,255,0.12)'
        ...
        {/* Back link */}
        <div style={{ marginTop: '3rem', animation: 'fadeSlideUp 0.7s 0.85s ease both' }}>
          <a
            href="/"
            style={{
              color: 'rgba(255,228,230,0.35)',
            ...
            onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,228,230,0.35)')}
          >
            ← Back to Home
          </a>
        </div>
